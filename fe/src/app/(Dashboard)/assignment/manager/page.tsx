...
import { changeRoomAsmAsync, createAsmAsync, getAssignmentManList, getAssignmentManListAsync, setOffAsmAsync } from '@/redux/slices/assignmentManSlice';
import { getACCforAddAsm1to6ListAsync, getaccList, getaccListAsync } from '@/redux/slices/accountSlice';
...
const UpdateAndDelAcc = () => {
    ...
    useEffect(() => {
        ...
        dispatch(getACCforAddAsm1to6ListAsync());
    }, []);
    ...
    const handleSubmit = (event: any) => {
        ...
        console.log(values)
        setCheckClose();
        dispatch(createAsmAsync(values));
        dispatch(getAssignmentManListAsync());
        dispatch(getACCforAddAsm1to6ListAsync());
    }
